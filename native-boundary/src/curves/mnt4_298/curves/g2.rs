...
pub type G2Affine = mnt4::G2Affine<super::Parameters>;
pub type G2Projective = mnt4::G2Projective<super::Parameters>;
pub type G2Prepared = mnt4::G2Prepared<super::Parameters>;
...
impl SWModelParameters for Parameters {
    const COEFF_A: Fq2 = super::Parameters::TWIST_COEFF_A;

use crate::curve_param::mnt4_298::{Fq, Fr, FR_ONE};
use ark_ec::{
    mnt4,
...
pub type G1Affine = mnt4::G1Affine<super::Parameters>;
pub type G1Projective = mnt4::G1Projective<super::Parameters>;
pub type G1Prepared = mnt4::G1Prepared<super::Parameters>;
